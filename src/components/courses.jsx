...
const courses = [
    {
        type: 'Trading',
        title: 'Dive deeper into Intra-Day Trading',
        desc: 'A software that develops products for software developers and developments.',
        price: '15000',
        discountedPrice: '5000',
    },
    {
        type: 'Trading',
        title: 'Mastering Futures & Options',
        desc: 'Track tasks and projects, use agile boards, measure progress.',
        price: '15000',
        discountedPrice: '5000',
    },
    {
        type: 'Trading',
        title: 'Revealing the secrets of Forex Trading',
        desc: 'Email collaboration and email service desk made easy.',
        price: '15000',
        discountedPrice: '5000',
    }
]
        ...
        <div className="bg-neutral-100">
            <div className="max-w-[85rem] mt-20 md:mt-28 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                    ...
                    {courses.map((course, index) => (
                        <div key={index} className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
                            ...
                            <div className="mt-auto flex border-t">
                                <span className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-lg font-medium rounded-es-xl bg-white text-black shadow-sm disabled:opacity-50 disabled:pointer-events-none" href="#">
                                    <p className="line-through text-gray-700">₹{course.price}</p>₹{course.discountedPrice}
                                </span>
                                <a className="w-full m-3 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md border border-[#7AE36A] text-gray-800 shadow-sm hover:bg-[#7AE36A] focus:outline-none focus:bg-[#7AE36A] disabled:opacity-50 disabled:pointer-events-none" href="#">
                                    Enroll Now
                                </a>
                            </div>
                        </div>
                ...
                <div className="w-full flex justify-center">
                    <button type="button" className="py-4 px-16 mt-10 flex items-center gap-x-2 text-sm font-medium transition-all duration-150 rounded-lg border-2 border-[#7AE36A] text-black hover:bg-[#7AE36A] focus:text-black focus:outline-none focus:bg-[#7AE36A] disabled:opacity-50 disabled:pointer-events-none">
                        <ArrowUpRight /> View All Courses
                    </button>
                </div>
            </div>
        </div>
